...
const linkSubs = document.querySelector('#linkSubs');
const linkAbout = document.querySelector('#linkAbout');
const PopupNameStr = document.querySelector('.popup-name-str');
const PopupDesStrId = document.querySelector('#popup-des-str');
const PopupLinkStr = document.querySelector('#popup-link-str');
const UploadVideoButton = document.querySelector('.upload-video-button');
const UploadPreviewButton = document.querySelector('.upload-preview-button');
const PopupVideoName = document.querySelector('#popup-video-name');
const PopupVideoDes = document.querySelector('#popup-video-des');
...
const StatisticStr = document.querySelector('.statistic-str');
const RegStr = document.querySelector('#reg-str');
const ViewsStr = document.querySelector('#views-str');
const VideosStr = document.querySelector('#videos-str');
const Plus = document.querySelector('.plus');
const SuccesLogProfile = document.querySelector('#SuccesLogProfile');
